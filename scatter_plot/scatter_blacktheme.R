list.of.packages <- c("ape","ggtree","phangorn","ggplot2", "ggdark")
...
sp + dark_theme_classic() +
  ...
  theme(axis.text=element_text(size=25,face="bold"),
        ...
        panel.grid.major = element_line(color = "grey", size = 0.2)) + # change grid color
  # theme(plot.background = element_rect(fill = 'black', colour = 'black'))+
  # theme(panel.background = element_rect(fill = 'black', colour = 'black'))+
  # theme(panel.grid.major = element_line(colour = "black")) +
  # theme(legend.background = element_rect(fill = 'black'))+
  theme(text = element_text(color="white", size=25,face="bold")) +
